...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        List<ObjectError> validationErrorMessage = ex.getAllErrors();

        validationErrorMessage.forEach(error -> {
    ...
    public ResponseEntity<ErrorResponseDto> handleResourceNotFoundException(WebRequest request, Exception exception) {
    ...
    public ResponseEntity<ErrorResponseDto> handleLoanAlreadyExistException(WebRequest request, Exception exception) {
